...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      <span className="hidden md:block absolute right-full top-1/2 -translate-y-1/2 mr-3 px-3 py-1.5 rounded-lg bg-[#0d1b3e] text-white text-sm font-medium whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none shadow-lg">
        Chat with us
        <span className="absolute left-full top-1/2 -translate-y-1/2 border-4 border-transparent border-l-[#0d1b3e]" />
      </span>
    </a>
  );
}